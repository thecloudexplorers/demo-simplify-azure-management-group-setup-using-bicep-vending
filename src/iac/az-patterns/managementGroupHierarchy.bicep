...
// Root management group (Tier 0)
@description('''The root management group object, which includes an id and displayName.
This management group will serve as the top-level parent for all other management groups.''')
param tier0ManagementGroup object

// Tier 1 management groups
@description('''An array of objects representing Tier 1 management groups. Each object must include an id and displayName.
These will be children of the Tier 0 management group.''')
param tier1ManagementGroups array = []

// Tier 2 management groups
@description('''An array of objects representing Tier 2 management groups.
Each object must include an id, displayName, and parentId. These will be children of the Tier 1 management groups.''')
param tier2ManagementGroups array = []

// Tier 3 management groups
@description('''An array of objects representing Tier 3 management groups.
Each object must include an id, displayName, and parentId. These will be children of the Tier 2 management groups.''')
param tier3ManagementGroups array = []

// Tier 4 management groups
@description('''An array of objects representing Tier 4 management groups.
Each object must include an id, displayName, and parentId. These will be children of the Tier 3 management groups.''')
param tier4ManagementGroups array = []

// Tier 5 management groups
@description('''An array of objects representing Tier 5 management groups. Each object must include an id, displayName,
and parentId. These will be children of the Tier 4 management groups.''')
param tier5ManagementGroups array = []

// Optional default management group for new subscriptions
@description('''Optional. The ID of the default management group for new subscriptions.
If not provided, new subscriptions will not be assigned to any management group by default.''')
...
@description('''Optional. Determines whether write permissions are required for creating new management groups. Default
is true.''')
...
module tier1ManagementGroupModule '../az-resources/managementGroupModule.bicep' = [
...
module tier2ManagementGroupModule '../az-resources/managementGroupModule.bicep' = [
...
module tier3ManagementGroupModule '../az-resources/managementGroupModule.bicep' = [
...
module tier4ManagementGroupModule '../az-resources/managementGroupModule.bicep' = [
...
module tier5ManagementGroupModule '../az-resources/managementGroupModule.bicep' = [
...
resource requireAuthForNewMGCreation 'Microsoft.Management/managementGroups/settings@2023-04-01' = {
